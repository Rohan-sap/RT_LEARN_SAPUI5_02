		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapprj3sapui5project3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapprj3sapui5project3-display": {
								"semanticObject": "sapprj3sapui5project3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.prj3.sapui5project3",
									"url": sap.ui.require.toUrl("sap/prj3/sapui5project3")
								}
							}
						}
					}
